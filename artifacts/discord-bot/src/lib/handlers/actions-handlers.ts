...
} from "../economy/payout-config.js";
import { getServerSettings, requireMcaEnabled } from "../db/server-settings.js";
import { getArticleStandings, getSeasonRecords, getAllTimeRecords } from "../franchise/gcs-fallback.js";
import { devBadge, devBadgeText, DEV_LEGEND, DEV_EMOJI, DEV_TRAIT_LABELS } from "../economy/dev-trait.js";
...
import {
  ...
  type MenuCtx,
} from "../menu/menu-hub.js";
import { buildUserProfilePages, buildProfileNavRow, buildProfileBackRow } from "../discord/user-stats-embed.js";
